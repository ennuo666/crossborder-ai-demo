...
export type ListingCreateInput = { productId: string; taskId?: string | null; title: string; titleZh?: string | null; bulletsZh?: string[]; descriptionZh?: string | null; researchContext?: import("@/lib/types").ListingResearchContext | null; bullets: string[]; description?: string | null; keywords: string[]; status?: string; aiUsage?: import("@/lib/types").AiUsageRecord | null };
