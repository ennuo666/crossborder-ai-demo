...
export const mockListingAdapter: ListingAdapter = { async generateListing() { return { state:"succeeded", source:"mock", data:{title:"PureFlow 净水壶", bulletPoints:["快速过滤"], description:"便携过滤体验", keywords:["water filter"]} }; } };
