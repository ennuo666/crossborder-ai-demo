...
export type MarketplaceProviderResult = { products: CompetitorProduct[]; marketplace:string; query:string; fetchedAt:string; enrichmentSuccessCount?: number; enrichmentFailures?: Array<{ externalId:string; code:string; message:string; status?:number }> };
